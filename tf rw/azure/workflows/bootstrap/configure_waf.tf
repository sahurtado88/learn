...
module "waf_common" {
  ...
  whitelist_ip_range               = module.whitelist.whitelist_ip_range
  rule_group_override              = var.rule_group_override
  custom_rules_monitoring          = var.monitoring_manage_external_access
  custom_rules_whitelist           = !var.external_access
  custom_rules_geolocation         = var.external_access
